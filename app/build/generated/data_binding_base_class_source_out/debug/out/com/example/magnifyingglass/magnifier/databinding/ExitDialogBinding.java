...
public final class ExitDialogBinding implements ViewBinding {
  ...
  private ExitDialogBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout bottomSheet, @NonNull Button cancel, @NonNull Button exit,
      @NonNull CardView layoutNative, @NonNull FrameLayout sheet,
      @NonNull NativeAdLayoutLoaderBinding shimmerFrameLayout, @NonNull TextView tvv) {
  ...
  public static ExitDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ExitDialogBinding((ConstraintLayout) rootView, bottomSheet, cancel, exit,
          layoutNative, sheet, binding_shimmerFrameLayout, tvv);
    }
