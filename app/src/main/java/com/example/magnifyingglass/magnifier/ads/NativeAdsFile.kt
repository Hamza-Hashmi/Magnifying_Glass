...
var obNativeAdFull: NativeAd? = null
...
fun Activity.changeNativeSize(
    ...
    nativeAd?.let {
        val layoutId =
            if (isSmall) R.layout.native_ad_layout_small else R.layout.native_ad_layout_main

        adView = layoutInflater.inflate(layoutId, null)
        populateUnifiedNativeAdView(it, (adView as NativeAdView), scaleType)
